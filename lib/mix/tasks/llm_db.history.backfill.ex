defmodule Mix.Tasks.LlmDb.History.Backfill do
  ...
  @shortdoc "Backfill model history from git commits into history/events NDJSON"
  ...
  - `history/events/YYYY.ndjson`
  - `history/snapshots.ndjson`
  - `history/meta.json`
  ...
  ## Usage
      ...
      mix llm_db.history.backfill --output-dir history
  ...
  - `--output-dir` - Directory for generated history files (default: `history`)
  """
